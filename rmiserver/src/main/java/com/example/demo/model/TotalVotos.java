...
public class TotalVotos implements Serializable {
    public Integer votoCandidato1;
    public Integer votoCandidato2;
    public Integer votoCandidato3;
    public Integer votoCandidatoNulo;

    public TotalVotos(){

    }
    public TotalVotos(Integer a, Integer b, Integer c, Integer x){
        this.votoCandidato1 = a;
        this.votoCandidato2 = b;
        this.votoCandidato3 = c;
        this.votoCandidatoNulo = x;
    }
